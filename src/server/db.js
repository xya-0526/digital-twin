...
import P24 from '../assets/images/P24.svg'
import P26 from '../assets/images/P26.svg'
...
export const Demonstrationarea = {
  ...
  data: {
    ...
    ecologicalData: {
      ...
      title: '总计人口',
      data: [
        { label: '数据一', value: 160, percentage: 42.6, unit: '万人', id: 0 },
        { label: '数据二', value: 130, percentage: 37.5, unit: '万人', id: 1 },
        { label: '数据三', value: 90, percentage: 19.9, unit: '万人', id: 2 }
      ]
    },
    ProportionUse: [
      { title: '建筑用地占比', land: 31.4, id: 0 },
      { title: '蓝绿空间占比', land: 26.8, id: 1 },
      { title: '蓝绿空间占比', land: 45.6, id: 2 }
    ],
    structure: [
      {
        id: 0,
...
export const WaterSurfacerate = {
  ...
  data: [
<<<<<<< Updated upstream
    { title: '数据一', value: 78.5, id: 0, icon: P24 },
    { title: '数据一', value: 6.2, id: 1, icon: P26 }
=======
    { title: '数据一', value: 78.5, id: 0, icon: '@assets/images/P24.svg' },
    { title: '数据一', value: 6.2, id: 1, icon: '.@assets/images/P26.svg' }
>>>>>>> Stashed changes
  ]
}
